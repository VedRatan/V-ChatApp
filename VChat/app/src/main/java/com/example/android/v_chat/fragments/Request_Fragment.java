package com.example.android.v_chat.fragments;
...
import com.example.android.v_chat.SearchFriends;
...
public class Request_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reqView= inflater.inflate(R.layout.fragment_request_, container, false);
        ...
        recyclerView=reqView.findViewById(R.id.requestsrecyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        floatingActionButton=reqView.findViewById(R.id.requestfloatbutton);
    ...
    public static class RequestViewHolder  extends RecyclerView.ViewHolder
    {
        ...
        public RequestViewHolder(@NonNull View itemView) {
            ...
            reqlinearLayout=itemView.findViewById(R.id.set_request);
