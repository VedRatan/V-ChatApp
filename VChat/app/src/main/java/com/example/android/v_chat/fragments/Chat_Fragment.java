...
import com.example.android.v_chat.ChatActivity;
...
public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chatview =inflater.inflate(R.layout.fragment_chat_, container, false);
        auth= FirebaseAuth.getInstance();
        CurrentUserID=auth.getCurrentUser().getUid();
        ContactRef= FirebaseDatabase.getInstance().getReference().child("Contacts").child(CurrentUserID);
        UserRef= FirebaseDatabase.getInstance().getReference().child("Users");
        recyclerView=chatview.findViewById(R.id.chatsrecyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        floatingActionButton=chatview.findViewById(R.id.chatfloatbutton);
